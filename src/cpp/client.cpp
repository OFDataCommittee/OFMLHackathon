...
void Client::_check_ssdb_string(const std::string& env_str) {

  /* This function checks that the ssdb string only contains permissable
  characters, and if a character is not allowed, an error will be thrown.
  */
